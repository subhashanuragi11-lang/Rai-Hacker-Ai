...
print("BOT STARTED")
print("HF TOKEN EXISTS =", bool(HF_ACCESS_TOKEN))
...
async def cmd_start(message: Message):
    print("ANY MESSAGE =", message.text, flush=True)
...
async def cb_ask_ai(callback: CallbackQuery):
    logger.info(f"ASK AI CLICKED BY {callback.from_user.id}")
    if is_banned(user_id):
...
async def handle_text(message: Message):
    await message.answer("DEBUG WORKING")
    print("===================================")
